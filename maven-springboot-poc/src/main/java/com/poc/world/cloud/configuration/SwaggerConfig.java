package com.poc.world.cloud.configuration;
...
public class SwaggerConfig {
    ...
    public Docket newsApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.poc.world.cloud.controller"))
                .build()
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .description("Ravi POC Micro Service API provides functionality for managing "
                        + "(create, retrieve, update, delete) for customer using maven.")
